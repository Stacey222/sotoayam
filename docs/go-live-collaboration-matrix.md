...
|---|---|---:|---:|---|---|---|
| `ONPAGE_B2C` | `CONTENT_CREATOR` | Yes | No | `ALL` | `CONFIRMED` and active | No |

All other source/target relationships are `BUSINESS_CONFIRMATION_REQUIRED`. They must not be seeded until the business owner confirms the direction, scope, and approval requirement. `SYSTEM_ADMIN` does not bypass this matrix.
