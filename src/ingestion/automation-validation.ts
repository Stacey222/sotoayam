...
export function parseAutomationIntake(value: unknown): TaskIntakeRequest {
  ...
  const allowed = ["external_reference", "title", "description", "priority", "owner_division", "assignee", "deadline", "task_category"];
  ...
  return { source: "AUTOMATION", title: body.title, ownerDivision: body.owner_division,
    ...
    taskCategory: taskCategory as TaskIntakeRequest["taskCategory"] };
}
