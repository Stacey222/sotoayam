...
describe("P1-09 clean migration harness", () => {
  it("discovers the complete ordered 24-migration schema manifest", async () => {
    ...
    expect(manifest.migrations.at(-1)).toBe("202609250001_create_first_owner_web_bootstrap.sql");
